...
public class exportDataController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            BorderPane borderpane = (BorderPane) FXMLLoader.load(getClass().getResource("/librarymanagementsystem/view/exportToPdf.fxml"));
    ...
    private void loadPDFExportPanel(ActionEvent event) throws IOException {
        BorderPane borderP = FXMLLoader.load(getClass().getResource("/librarymanagementsystem/view/exportToPdf.fxml"));
        borderPane.setCenter(borderP);
    }

    @FXML
    private void loadPDFExceltPanel(ActionEvent event) throws IOException {
        BorderPane borderP = FXMLLoader.load(getClass().getResource("/librarymanagementsystem/view/exportToExcel.fxml"));
        borderPane.setCenter(borderP);
    }

    @FXML
    private void loadWordExportPanel(ActionEvent event) throws IOException {
        BorderPane borderP = FXMLLoader.load(getClass().getResource("/librarymanagementsystem/view/exportToWord.fxml"));
        borderPane.setCenter(borderP);
    }
