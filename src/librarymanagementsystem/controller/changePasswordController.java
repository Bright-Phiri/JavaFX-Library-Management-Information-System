...
public class changePasswordController implements Initializable {
            ...
            try {
                ...
                if (rs.next()) {
                    if (newPassword.getText().equals(newpassword2.getText())) {
                        ...
                        librarymanagementsystem.model.Alert alert = new librarymanagementsystem.model.Alert(AlertType.INFORMATION, "Information", "Passwords don't match");
                        newPassword.clear();
                        newpassword2.clear();
                    }
                } else {
                    librarymanagementsystem.model.Alert alert = new librarymanagementsystem.model.Alert(AlertType.INFORMATION, "Information", "Current password is not correct");
                }
    ...
    private boolean validateFields() {
        if (currentPassword.getText().isEmpty() || newPassword.getText().isEmpty() || newpassword2.getText().isEmpty()) {
            librarymanagementsystem.model.Alert alert = new librarymanagementsystem.model.Alert(AlertType.INFORMATION, "Fields validation", "Please enter in all fields");
            return false;
        } else {
            return true;
        }
    ...
    private boolean validatePasswordLength() {
        if (newPassword.getText().length() < 8 || newpassword2.getText().length() < 8) {
            librarymanagementsystem.model.Alert alert = new librarymanagementsystem.model.Alert(AlertType.INFORMATION, "Password length validation", "The password must be at least 8 characters long");
            return false;
        }
        return true;
    }
